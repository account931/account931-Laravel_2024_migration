...
// public/api/owners  //same working as below route
// Route::get('/owners', function () { return new OwnerResource(Owner::find(1)); }); //same as above, working
Route::get('/owner/{owner}',           [OwnerController::class, 'show'])->name('api/owner/');
// public/api/owner/{owner}  //1 owner  //Implicit Route Model Binding
